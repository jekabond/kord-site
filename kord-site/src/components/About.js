...
const About = () => {
  ...
  const imgSrc = isMobile
    ? `${process.env.PUBLIC_URL}/pictures/about_vertical.jpg`
    : `${process.env.PUBLIC_URL}/pictures/about_horizont.jpg`;
    ...
    <section className="about" id="about">
      ...
      <div className="container about__content">
        ...
        <p className="about__desc reveal" style={{ '--reveal-delay': '0.2s' }}>
          входить до складу "Спецпідрозділу Тимура" Головного управління розвідки Міністерства оборони України.
